...
import type { ClipSegment, Word } from "@/motionscript/lib/types";
import { isDisfluencyPlaceholder } from "@/motionscript/lib/disfluencies";
import { findPauses, formatPause } from "@/motionscript/lib/pauses";
import { VAD_SAMPLE_RATE } from "@/motionscript/lib/vad";
import { peakBetween } from "@/motionscript/lib/waveform";
import { useCutRanges } from "@/motionscript/hooks/useCutRanges";
import { useIsDark } from "@/motionscript/hooks/useIsDark";
import { useI18n } from "./I18nProvider";
import OverlayTrack from "./overlay/OverlayTrack";
      ...
      <div ref={outerRef} className="relative min-h-0 flex-1">
        ...
        >
          <div className="relative h-full" style={{ width: totalWidth }}>
            {/* What sits on top of the video, on the same ruler as the cut. */}
            <OverlayTrack
              pps={pps}
              top={RULER_H + WORDBAR_H + 3}
