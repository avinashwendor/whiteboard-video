...
import { isDisfluencyPlaceholder } from "@/motionscript/lib/disfluencies";
...
import {
  ...
  parseTranscriptFile,
  TRANSCRIPT_ACCEPT,
} from "@/motionscript/lib/parseTranscript";
import type { Word } from "@/motionscript/lib/types";
...
import {
  ...
  mapSplitsToWords,
  originalToEdited,
} from "@/motionscript/lib/edits";
import { sentenceAround, type SlashContext, type SlashResult } from "@/motionscript/lib/slash";
import TranscriptSlashMenu from "./TranscriptSlashMenu";
import { useCapabilities } from "@/motionscript/hooks/useCapabilities";
import { useOutputTimeline } from "@/motionscript/hooks/useOverlayTimeline";
import { useOverlayStore } from "@/motionscript/lib/overlay/store";
import { useChatStore } from "@/motionscript/lib/chat/store";
import { runPlan } from "@/motionscript/lib/overlay/ops";
import { useTranscriptSelection } from "@/motionscript/hooks/useTranscriptSelection";
import { useTranscriptCaret } from "@/motionscript/hooks/useTranscriptCaret";
import { findPauses, formatPause, type Pause } from "@/motionscript/lib/pauses";
import { useTranscriptPlayheadFollow } from "@/motionscript/hooks/useTranscriptPlayheadFollow";
import { useWordAnchorFloating } from "@/motionscript/hooks/useWordAnchorFloating";
import { useCutRanges } from "@/motionscript/hooks/useCutRanges";
import { findActiveWordId, groupWordsBySpeaker } from "@/motionscript/lib/transcript";
import { isTypingTarget } from "@/motionscript/lib/keyboard";
import { useI18n } from "./I18nProvider";
import { localizeRuntimeMessage } from "@/motionscript/lib/i18n";
