...
import { generateImage, searchPhoto } from "@/motionscript/lib/overlay/ops";
...
import type { TextStyleName } from "@/motionscript/lib/overlay/ops-schema";
import type { OverlayElement } from "@/motionscript/lib/overlay/types";
          ...
          <div className="grid grid-cols-3 gap-1.5">
            {tray.map((item) => (
              <button
                ...
                draggable
                onDragStart={(e) => {
                  e.dataTransfer.setData("application/x-motionscript-image", item.url);
