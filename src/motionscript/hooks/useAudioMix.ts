...
import { audibleClips, gainAt, DUCK_DEPTH, type AudioClip } from "@/motionscript/lib/overlay/audio";
import type { OutputTimeline } from "@/motionscript/lib/overlay/timeline";
import { originalToEdited } from "@/motionscript/lib/edits";
