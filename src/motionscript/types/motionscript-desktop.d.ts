import type { UiLocale } from "@/motionscript/lib/i18n/locales";
 ...
 *  main process calls `window.motionscriptOpenFilePicker` instead. */
...
declare global {
  interface Window {
    motionscriptDesktop?: MotionScriptDesktop;
    ...
    motionscriptOpenFilePicker?: () => void;
  }
}
