...
import type { Word, WorkerRequest, WorkerResponse } from "@/motionscript/lib/types";
import {
  MODELS,
  isParakeetModel,
  isWhisperModel,
  ...
  type ModelId,
  type WhisperModel,
} from "@/motionscript/lib/models";
import { cleanTranscript } from "@/motionscript/lib/hallucinations";
import {
  ALIGN_LEAD_S,
  alignWordsToSpeech,
  applyAlignLead,
  speechEnvelope,
} from "@/motionscript/lib/align";
import {
  ALIGN_MODELS,
  alignModelFor,
  type AlignModelInfo,
} from "@/motionscript/lib/alignModels";
import { insertDisfluencyPlaceholders } from "@/motionscript/lib/disfluencies";
import {
  diarizationWindows,
  stitchDiarizationWindows,
  type DiarizationSegment,
  type DiarizationWindow,
} from "@/motionscript/lib/diarize";
import {
  alignBatch,
  expandToAcoustics,
  ...
  type CtcVocab,
} from "@/motionscript/lib/forcedAlign";
import {
  isSpecificLanguage,
  type TranscriptLanguage,
  type TranscriptLanguageSetting,
} from "@/motionscript/lib/languages";
import { isIndicLanguage } from "@/motionscript/lib/indic";
import { detectLanguageFromText } from "@/motionscript/lib/scriptDetect";
import { localModelPresent } from "@/motionscript/lib/localModels";
import {
  VAD_FRAME_SIZE,
  VAD_SAMPLE_RATE,
  energySpeechFrames,
  ...
  type SpeechSegment,
} from "@/motionscript/lib/vad";
import { isNetworkError, installFetchRetry } from "@/motionscript/lib/network";
import { isWebGpuDeviceLostError } from "@/motionscript/lib/webgpu";
