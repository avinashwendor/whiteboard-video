 ...
 *
 * This is where every saved project lives. Renaming the database does not
 * move the data into it — it opens an empty one and every project a user has
 * made disappears. Changing it needs a migration that copies the old store
 * across on first open, not a find-and-replace.
 */
