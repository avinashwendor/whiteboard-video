...
export const en = {
  ...
  "proofread.title": "Proofread with AI",
  "proofread.checking": "Checking the transcript…",
  "proofread.none": "No corrections suggested.",
  "proofread.failed": "Could not proofread the transcript.",
  "proofread.apply": "Apply {count}",
  "pauses.title": "Pause threshold",
  "pauses.count": "{count} pause",
  "pauses.countPlural": "{count} pauses",
  "pauses.hint": "Gaps shorter than this are the rhythm of speech, not silence worth cutting.",
